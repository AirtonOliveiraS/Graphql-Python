...
from .db_functions import( create_pessoas, get_pessoas,
 get_books, create_books, delete_pessoas, update_pessoas)
import strawberry
...
class Mutation:
        ...
        delete_pessoa: str = strawberry.field(resolver= delete_pessoas)
        update_pessoa:Pessoa = strawberry.field(resolver= update_pessoas)
